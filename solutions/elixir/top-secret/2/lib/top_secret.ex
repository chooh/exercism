defmodule TopSecret do
  ...
  defp decode_from_ast({:when, _, [ast | _]}), do: decode_from_ast(ast)
  defp decode_from_ast({_op, _, nil}), do: ""
  defp decode_from_ast({op, _, args}), do: op |> Atom.to_string() |> String.slice(0, length(args))
