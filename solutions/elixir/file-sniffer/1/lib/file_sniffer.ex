defmodule FileSniffer do
  ...
  def type_from_binary(file_binary) do
    case file_binary do
      ...
      <<0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, _reset::binary>> -> "image/png"
      <<0xFF, 0xD8, 0xFF, _reset::binary>> -> "image/jpg"
  ...
  def verify(file_binary, extension) do
    ...
    if from_binary == from_extension and !is_nil(from_binary) do
      {:ok, from_extension}
    else
